...
<br></br>
<h1 style="color:white"> SUB EVENT </h1>


<p style="color:white;">Please choose which record to view student</p>
<form action="viewstudent.php" name="viewstudent" method="POST">
...
?>
<tr>
	<td><input type="radio" name="event_ID" value="<?php echo $row['event_ID'];?>"></td>
