...
<br></br>
<h1 style="color:white"> DELETE SUB EVENT </h1>


<p style="color:white;">Please choose which record to delete</p>

<form action="deletesuccess.php" name="deletesuccess" method="POST" onSubmit="return confirm('Are you sure to DELETE this record?')">
