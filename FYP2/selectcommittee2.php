...
{
  $queryView = "select * from USER WHERE UserType LIKE '%committee%' ";
...
<a href="manage_committee.php" > <img src = "cluventlogo.png"  width="170" height="170" > </a>
</div>
<br></br>

<form action="deletecommitteesuccess.php" name="edit_committee" method="POST">
...
<br><br>
<input type="Submit" class="button" value="Delete Committee">
