...
<a href="selectcommittee.php" > <img src = "cluventlogo.png"  width="170" height="170" > </a>
<br></br>
</div>
<br></br>
<?php
...
<form action="edit_committee_success.php" name="edit_committee_success"  method="POST">
