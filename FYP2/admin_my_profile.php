...
<br><br>
<button  onclick="document.location='ADMIN_HOME_PAGE.php'"type="submit">HOME PAGE</button>
<br><br>
<button  onclick="document.location='admin_profile_update.php'"type="submit">EDIT PROFILE</button>
<br><br>
</div>
</center>
</body>
