...
<br></br>
<button onclick="document.location='manage_event.php'" style="margin-bottom:100px;" type="submit">EVENT</button>
<button onclick="document.location='manage_student.php'" style="margin-bottom:100px;" type="submit">STUDENT</button>
<button onclick="document.location='manage_committee.php'" style="margin-bottom:100px;"type="submit">COMMITTEE</button>
