...
{
  $queryView = "SELECT REGISTEREVENT.RegisterID, REGISTEREVENT.UserID, USER.FullName, USER.Username, USER.Email, USER.PhoneNum, USER.Gender, USER.Scorun
  FROM REGISTEREVENT INNER JOIN USER ON USER.UserID=REGISTEREVENT.UserID
  WHERE REGISTEREVENT.EventID = '".$_POST["EventID"]."'";
...
<a href="event_added.php" > <img src = "cluventlogo.png"  width="170" height="170" > </a>
...
<tr>
  ...
  else 
  {
	  ...
	  echo "<br><br>";		
	  echo "Click <a style='color:red;'href='event_added.php'> No Record Found </a> to select again";
