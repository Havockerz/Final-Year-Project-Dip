...
<tr>
  ...
  else 
  {
	  ...
	  echo "<br><br>";		
	  echo "Click <a href='Eventpage.php'> here </a> to Main Page";
...
<br><br>
<a href="selectcommittee.php" class="button">Edit Committee</a>
<a href="selectcommittee2.php" class="button">Delete Committee</a>
<br><br>
</div>
</body>
