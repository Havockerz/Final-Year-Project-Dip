...
<br></br>
<h1 style="color:white"> DELETE EVENT </h1>


<p style="color:white;">Please choose which record to delete</p>

<form action="delete_success.php" name="delete_success" method="POST" onSubmit="return confirm('Are you sure to DELETE this record?')">
...
<br><br>
<input type="Submit" value="Delete chosen event">
<br><br>
</form>
