...
<button onclick="document.location='edit_event.php'" style="margin-bottom:100px;" type="submit">EDIT EVENT</button>
<button onclick="document.location='delete_event.php'" style="margin-bottom:100px;"type="submit">DELETE EVENT</button>
<button onclick="document.location='event_added.php'" style="margin-bottom:100px;"type="submit">VIEW PARTICIPANT</button>
