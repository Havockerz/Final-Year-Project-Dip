...
<br></br>
<h1 style="color:white"> EVENT HAS BEEN EDITED </h1>
<br></br>
</div>
...
{
	$queryDelete = "DELETE FROM EVENT WHERE EventID = '".$EventID."' ";
	
	if ($conn->query($queryDelete) === TRUE) {
		echo "<p style='color:blue;'>Record deleted successfully</p>";
		echo "<br><br>";
		echo "<a style ='color:white;' href='eventviewpage.php'> View all events </a> ";
	} else {
