...
<br></br>
<p style="color:white">PLEASE CHOOSE A RECORD TO DELETE</p>
<br></br>
</div>
<br></br>

<form action="admindeletesuccess.php" name="admindeletesuccess" method="POST" onSubmit="return confirm('Are you sure to DELETE this record?')">
<table class="table">
...
<br><br>
<input type="Submit" class="button" value="Delete Chosen Event">
<br><br>
</form>
